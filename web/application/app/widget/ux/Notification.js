Ext.define("Keer.widget.ux.Notification",{
			...
			if (me.manager && me.manager.el && me.manager.el.dom) {
				if (me.useXAxis) {
					...
					getXposAlignedToSibling : function(sibling) {
						...
						if (me.useXAxis) {
							if (me.position === "tl" || me.position === "bl"
									|| me.position === "l") {
								return sibling.xPos + sibling.el.getWidth()
										+ sibling.spacing;
							} else {
								return sibling.xPos - me.el.getWidth()
										- me.spacing;
							}
						} else {
							return me.el.getLeft();
					...
					getYposAlignedToSibling : function(sibling) {
						...
						if (me.useXAxis) {
							...
							if (me.position === "tr" || me.position === "tl"
									|| me.position === "t") {
								return sibling.yPos + sibling.el.getHeight()
										+ sibling.spacing;
							} else {
								return sibling.yPos - me.el.getHeight()
										- sibling.spacing;
							}
						}
					},
					...
					beforeShow : function() {
						...
						if (me.autoHide) {
							me.task = new Ext.util.DelayedTask(me.doAutoHide,
									me);
