Ext.define('Keer.store.Organization.Model',{
	extend: 'Keer.widget.model.Model',
	config: {
		actionUrl: 'Organization',
		actionBean: 'Organization',
		actionMethod: 'findAll',
		parentProp: 'parent',
		categoryProp: 'parent'
	},
	inheritableStatics: {
		clazzname: 'com.keer.core.bean.organization.Organization'
	},
	fields : [
		{name:'user',configMap:{mainMemberember:{orgType:null,createdTime:null,remark:null,status:null,code:null,version:null,id:null,indexCls:null,sortno:null,privilegeMap:null,name:null,modifyFlag:null,clazzname:null},createdTime:null,remark:null,status:null,code:null,password:null,version:null,indexCls:null,id:null,sortno:null,loginname:null,privilegeMap:null,name:null,modifyFlag:null,isAdmin:null,clazzname:null},defaultValue:null},
