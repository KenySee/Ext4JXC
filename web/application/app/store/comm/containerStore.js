Ext.define('Keer.store.comm.containerStore',{
	extend: 'Ext.data.Store',
	storeId: 'comm-containerstore',
	alias: 'widget.comm-containerstore',
	fields : [
	...
	proxy : {
		...
		extraParams: {clazzname:'com.keer.core.bean.model.WidgetContainer'},
