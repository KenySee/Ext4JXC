Ext.define('Keer.ui.core.PartArtist.PartStory.ChildContainer',{
	extend: 'Keer.widget.view.Container',
	alias: 'widget.ui-core-PartArtist-PartStory-childcontainer',
	controller: 'Keer.ui.core.PartArtist.PartStory.ChildController',
	requires:[
		'Keer.store.PartStory.Store',
		'Keer.ui.core.PartArtist.PartStory.ChildController'
	],	
	config:{
		canMulti: false,
		innerEdit: false,
