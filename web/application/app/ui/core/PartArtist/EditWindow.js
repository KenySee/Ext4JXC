Ext.define('Keer.ui.core.PartArtist.EditWindow',{
	extend: 'Keer.widget.view.EditWindow',
	alias: 'widget.ui-core-PartArtist-editwindow',
	controller: 'Keer.ui.core.PartArtist.EditController',
	//【加载依赖】
	requires: [
		...
		'Keer.ui.core.PartArtist.EditController'
	],
	//【混入功能】
	mixins: {
	},	
