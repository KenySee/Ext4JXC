Ext.define('Keer.ui.core.PartArtist.PartArticle.EditWindow',{
	extend: 'Keer.widget.view.EditWindow',
	alias: 'widget.ui-core-PartArtist-PartArticle-editwindow',
	controller: 'Keer.ui.core.PartArtist.PartArticle.EditController',
	//【加载依赖】
	requires: [
		'Keer.ui.core.PartArtist.PartArticle.EditController'
	],
	//【混入功能】
	mixins: {
	},	
