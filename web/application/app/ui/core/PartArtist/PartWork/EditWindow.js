Ext.define('Keer.ui.core.PartArtist.PartWork.EditWindow',{
	extend: 'Keer.widget.view.EditWindow',
	alias: 'widget.ui-core-PartArtist-PartWork-editwindow',
	controller: 'Keer.ui.core.PartArtist.PartWork.EditController',
	//【加载依赖】
	requires: [
		...
		'Keer.ui.core.PartArtist.PartWork.EditController'
	],
	//【混入功能】
	mixins: {
	},	
