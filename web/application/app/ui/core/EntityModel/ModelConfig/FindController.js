Ext.define('Keer.ui.core.EntityModel.ModelConfig.FindController',{
	...
	control: {
		...
		button_confirm: {	listeners: { click: 'onButtonConfirm' }	},
		button_cancel:  {	listeners: { click: 'onButtonCancel' }	},
