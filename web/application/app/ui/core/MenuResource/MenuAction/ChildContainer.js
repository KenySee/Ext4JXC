Ext.define('Keer.ui.core.MenuResource.MenuAction.ChildContainer',{
	extend: 'Keer.widget.view.Container',
	alias: 'widget.ui-core-MenuResource-MenuAction-childcontainer',
	controller: 'Keer.ui.core.MenuResource.MenuAction.ChildController',
	requires:[
	...
	initConfig: function (config) {
		Ext.apply(config,{
			gridStore: config.store || Ext.widget('MenuAction-store',{controller: this.getController()})
		});
