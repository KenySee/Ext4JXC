Ext.define('Keer.ui.core.PartWork.MainContainer',{
	extend: 'Keer.widget.view.Container',
	alias: 'widget.ui-core-PartWork-maincontainer',
	controller: 'Keer.ui.core.PartWork.MainController',
	requires:[
		'Keer.store.PartWork.Store',
		'Keer.store.PartArtist.Store',
		'Keer.ui.core.PartWork.MainController'
	],	
	config:{
		canMulti: false,
		innerEdit: false,
