Ext.define('Keer.ui.core.PartWork.PartWorkContent.EditWindow',{
	extend: 'Keer.widget.view.EditWindow',
	alias: 'widget.ui-core-PartWork-PartWorkContent-editwindow',
	controller: 'Keer.ui.core.PartWork.PartWorkContent.EditController',
	//【加载依赖】
	requires: [
		'Keer.widget.field.EnumCombo',
		'Keer.ui.core.PartWork.PartWorkContent.EditController'
	],
	//【混入功能】
	mixins: {
	},	
	...
	initComponent: function(){
		Ext.apply(this,{
			...
			formFields : [
				{fieldLabel:'内容序号',name:'contentIndex',itemId:'contentIndex',dataIndex:'contentIndex',xtype:'textfield',addFocus:'adding'},
				...
				{fieldLabel:'类型值',name:'contentValue',itemId:'contentValue',dataIndex:'contentValue',xtype:'textarea',fullLine:true}
			]
		});
		this.callParent(arguments);
	}
