Ext.define('Keer.ui.core.PartWork.PartWorkContent.ChildContainer',{
	extend: 'Keer.widget.view.Container',
	alias: 'widget.ui-core-PartWork-PartWorkContent-childcontainer',
	controller: 'Keer.ui.core.PartWork.PartWorkContent.ChildController',
	requires:[
		'Keer.store.PartWorkContent.Store',
		'Keer.ui.core.PartWork.PartWorkContent.ChildController'
	],	
	config:{
		canMulti: false,
		innerEdit: false,
	...
	initConfig: function (config) {
		Ext.apply(config,{
			gridStore: config.store || Ext.widget('PartWorkContent-store',{
