Ext.define('Keer.ui.core.PartArticle.PartArticleContent.ChildController', {
    ...
    onCreateRecord: function (component, record) {
        ...
        var parent = this.get('parent');
        if (parent) {
            record.set('article', this.getJSONBean(parent, 'title'));
        }
    },
    ...
    doEdit: function () {
        ...
        if (model) {
            this.doOpenEditWindow('ui-core-PartArticle-PartArticleContent-editwindow', grid, store, model, false);
        }
        else {
    ...
    doAddRecord: function (store, model) {
        var grid = this.getGridView();
        this.doOpenEditWindow('ui-core-PartArticle-PartArticleContent-editwindow', grid, store, model, true);
    },
    doRemove: function () {
        var store = this.getGridStore();
        var grid = this.getGridView();
