Ext.define('Keer.ui.core.PartArticle.PartArticleContent.EditWindow',{
	extend: 'Keer.widget.view.EditWindow',
	alias: 'widget.ui-core-PartArticle-PartArticleContent-editwindow',
	controller: 'Keer.ui.core.PartArticle.PartArticleContent.EditController',
	//【加载依赖】
	requires: [
		'Keer.widget.field.EnumCombo',
		'Keer.ui.core.PartArticle.PartArticleContent.EditController'
	],
	//【混入功能】
	mixins: {
	},	
	...
	initComponent: function(){
		Ext.apply(this,{
			...
			formFields : [
				...
				{fieldLabel:'内容类型',name:'contentType',itemId:'contentType',dataIndex:'contentType',xtype:'widget-field-enumcombo',store:Keer.enumstore['contentType'],displayField:'name'},
				{fieldLabel:'类型值',name:'contentValue',itemId:'contentValue',dataIndex:'contentValue',xtype:'textarea',fullLine:true,growMin:2}
			]
		});
		this.callParent(arguments);
	}
