Ext.define('Keer.ui.core.PartArticle.MainContainer',{
	extend: 'Keer.widget.view.Container',
	alias: 'widget.ui-core-PartArticle-maincontainer',
	controller: 'Keer.ui.core.PartArticle.MainController',
	requires:[
		'Keer.store.PartArticle.Store',
		'Keer.store.PartArtist.Store',
		'Keer.ui.core.PartArticle.MainController'
	],	
	config:{
		canMulti: false,
		innerEdit: false,
