Ext.define('Keer.ui.selwin.MenuAction.FindWindow',{
	extend: 'Keer.widget.core.FindWindow',
	alias: 'widget.ui-selwin-MenuAction-findwindow',
	controller: 'Keer.ui.selwin.MenuAction.FindController',
	requires:[
