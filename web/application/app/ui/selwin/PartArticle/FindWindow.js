Ext.define('Keer.ui.selwin.PartArticle.FindWindow',{
	extend: 'Keer.widget.view.FindWindow',
	alias: 'widget.ui-selwin-PartArticle-findwindow',
	controller: 'Keer.ui.selwin.PartArticle.FindController',
	requires:[
		'Keer.widget.view.Grid',
		'Keer.widget.view.DataView',
		'Keer.store.PartArticle.Store',
		'Keer.store.PartArtist.Store',
		'Keer.ui.selwin.PartArticle.FindController'
	],	
	config:{
		canMulti: false,
		innerEdit: false,
	...
	initConfig: function (config) {
		...
		Ext.apply(config,{
			gridStore: Ext.widget('PartArticle-store',config.gridStoreConfig),
	...
	initComponent: function(){
		Ext.apply(this,{
			queryToolbar:{
				...
				items: [
				{fieldLabel:'标题',name:'title',itemId:'title',dataIndex:'title',labelWidth:60,xtype:'textfield'}
				]
			},
			cmdToolbar:[],
			gridColumns:[
