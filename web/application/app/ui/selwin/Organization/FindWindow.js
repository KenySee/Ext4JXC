Ext.define('Keer.ui.selwin.Organization.FindWindow',{
	extend: 'Keer.widget.core.FindWindow',
	alias: 'widget.ui-selwin-Organization-findwindow',
	controller: 'Keer.ui.selwin.Organization.FindController',
	requires:[
	...
	initComponent: function(){
		Ext.apply(this,{
			...
			gridColumns:[								
				...
				{text:'机构编号',dataIndex:'code',width:100},
