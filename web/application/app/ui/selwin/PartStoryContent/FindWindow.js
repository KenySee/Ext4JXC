Ext.define('Keer.ui.selwin.PartStoryContent.FindWindow',{
	extend: 'Keer.widget.view.FindWindow',
	alias: 'widget.ui-selwin-PartStoryContent-findwindow',
	controller: 'Keer.ui.selwin.PartStoryContent.FindController',
	requires:[
		'Keer.widget.view.Grid',
		'Keer.widget.view.DataView',
		'Keer.store.PartStoryContent.Store',
		'Keer.ui.selwin.PartStoryContent.FindController'
	],	
	config:{
		canMulti: false,
		innerEdit: false,
	...
	initConfig: function (config) {
		...
		Ext.apply(config,{
			gridStore: Ext.widget('PartStoryContent-store',config.gridStoreConfig)
		});
	...
	initComponent: function(){
		Ext.apply(this,{
			...
			gridColumns:[
				...
				,{text:'内容序号',dataIndex:'contentIndex',width:120}
