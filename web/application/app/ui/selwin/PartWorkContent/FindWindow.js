Ext.define('Keer.ui.selwin.PartWorkContent.FindWindow',{
	extend: 'Keer.widget.view.FindWindow',
	alias: 'widget.ui-selwin-PartWorkContent-findwindow',
	controller: 'Keer.ui.selwin.PartWorkContent.FindController',
	requires:[
		'Keer.widget.view.Grid',
		'Keer.widget.view.DataView',
		'Keer.store.PartWorkContent.Store',
		'Keer.ui.selwin.PartWorkContent.FindController'
	],	
	config:{
		canMulti: false,
		innerEdit: false,
	...
	initConfig: function (config) {
		...
		Ext.apply(config,{
			gridStore: Ext.widget('PartWorkContent-store',config.gridStoreConfig)
		});
