Ext.define('Keer.ui.core1.PartWork.MainContainer',{
	extend: 'Keer.widget.view.Container',
	alias: 'widget.ui-core1-PartWork-maincontainer',
	controller: 'Keer.ui.core1.PartWork.MainController',
	requires:[
		'Keer.store.PartWork.Store',
		'Keer.store.PartArtist.Store',
		'Keer.ui.core1.PartWork.MainController'
	],	
	config:{
		canMulti: false,
		innerEdit: false,
