Ext.define('Keer.ui.selwin.${appfolder}.FindWindow',{
	extend: 'Keer.widget.view.FindWindow',
	alias: 'widget.ui-selwin-${appfolder}-findwindow',
	controller: 'Keer.ui.selwin.${appfolder}.FindController',
	requires:[
		...
		'Keer.ui.selwin.${appfolder}.FindController'
	],	
	config:{
		canMulti: false,
		innerEdit: false,
