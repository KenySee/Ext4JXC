...
@Action("PartWorkSpecificationAction")
@SuppressWarnings({"serial","rawtypes"})
public class PartWorkSpecificationAction extends CRUDAction<PartWorkSpecification> {
	...
	public void buildFilterString(Class<JSONBean> clazz, SQLBuilder builder) throws Exception {
		...
		if (beanName.equals("PartWorkSpecification")){
		}
	}
}
