...
@Entity
@Description(Name="复选编辑框",Group="Ext.form.field.Checkbox",Desc="checkbox")
@SuppressWarnings("serial")
public class EditorCheckBox extends Editor {

	@Override
	public String toConfig(ModelDesc desc) {
		JSONObject config = new JSONObject();
		config.accumulate("xtype", this.AsString("checkbox"));
